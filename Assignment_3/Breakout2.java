...
/** Label delay time */	
	private static final int LABEL_DELAY_TIME = 2000;
	
/** Delay time between cycles (in milliseconds) */
...
/* creat the start screen */
	private void setStartLabel() {
		...
		GLabel startLabel = new GLabel(str);
		startLabel.setFont(new Font("Serif", Font.BOLD, 18));
		startLabel.setLocation((WIDTH - startLabel.getWidth()) / 2, HEIGHT / 2.5);
